...
//    [self.view addConstraints:@[leadingContstraint, trailingContstraint, bottomContstraint]];
    ...
    UIImageView *inputBackgroundImageView = [[UIImageView alloc] initWithFrame:CGRectMake(95, 8, SCREENWIDTH - 98 - 20, 30)];
    inputBackgroundImageView.image        = [UIImage imageNamed:@"chat_input"];
    [_bottomView addSubview:inputBackgroundImageView];

    //输入框
    _chatTextField                        = [[UITextField alloc] initWithFrame:CGRectMake(98, 13, SCREENWIDTH - 98 - 20, 25)];
