...
-(void)setupViewS{
    ...
    _friendTableView.frame          = CGRectMake(0, ViewOriginY, SCREENWIDTH ,SCREENHEIGHT-64-49);
...
-(void)initTableViewHeaderView{
    ...
    //附近的人
    ContactHeaderView *nearbyView         = [[ContactHeaderView alloc] initWithFrame:CGRectMake(0, 70, SCREENWIDTH, 70)];
