...
@interface BRegisterViewController ()<UITextFieldDelegate,LocationDelegate>
...
- (void)viewDidLoad
{
    ...
    loginBackgroundImageView.frame         = CGRectMake(0, ViewOriginY + 24, SCREENWIDTH, 125);
    ...
    lineImageView.frame = CGRectMake(0, ViewOriginY + 67, SCREENWIDTH, 1);
    ...
    lineImageView1.frame = CGRectMake(0, ViewOriginY + 108, SCREENWIDTH, 1);
